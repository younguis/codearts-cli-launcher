// CodeArts CLI 启动器：标题栏按钮 / 命令面板 / 资源管理器右键 在独立分组终端中启动 codearts
const vscode = require('vscode');
const cp = require('child_process');
const path = require('path');

const CLI_COMMAND = 'codearts';
const BASE_NAME = 'CodeArts';
...
function activate(context) {
	context.subscriptions.push(
		...
		vscode.commands.registerCommand('codeartsCli.launch', () => launch(resolveWorkspaceCwd())),
		// 资源管理器右键：在指定文件夹启动
		vscode.commands.registerCommand('codeartsCli.launchHere', (uri) =>
